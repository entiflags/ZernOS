...
void gdt_initialize()
{
	...
	write_gdt_entry(0x00, { 0, 0x00000, 0x00, 0x0 });
	write_gdt_entry(0x08, { 0, 0xFFFFF, 0x9A, 0xC });
	write_gdt_entry(0x10, { 0, 0xFFFFF, 0x92, 0xC });
	write_gdt_entry(0x18, { 0, 0xFFFFF, 0xFA, 0xC });
	write_gdt_entry(0x20, { 0, 0xFFFFF, 0xF2, 0xC });
