...
void Widget::GetFocus(Widget* widget){
    ...
    //pass the call to the parent and the parent passes it to it's parent till it hits the root parent and the root parent must override this function and give the most child the focus.
}
...
void Widget::ModelToScreen(int32_t &x, int32_t &y){
    ...
    if(parent != 0){                //IF there's a parent
        parent->ModelToScreen(x,y); //Pass on the parent
    }
